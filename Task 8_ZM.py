...
Locker_size = {
    'S': {'space': 4, 'range': (1, 4)},
    'M': {'space': 9, 'range': (5, 9)},
    'L': {'space': 14, 'range': (10, 14)},
    'XL': {'space': 18, 'range': (15, 18)}}

Module_type= {
    'M1': {'S': 20, 'M': 5, 'L': 2, 'XL': 0},
    'M2': {'S': 12, 'M': 10, 'L': 3, 'XL': 1},
    'M3': {'S': 6, 'M': 14, 'L': 3, 'XL': 1},
    'M4': {'S': 2, 'M': 4, 'L': 8, 'XL': 4},
    'M5': {'S': 2, 'M': 2, 'L': 6, 'XL': 8},
    'M6': {'S': 8, 'M': 8, 'L': 8, 'XL': 4},}

#Calculate total probability for each locker_size
Space_prob = {1: 0.08, 2: 0.12, 3: 0.15, 4: 0.12, 
              5: 0.08, 6: 0.06, 7: 0.05, 8: 0.05, 9: 0.05, 
              10: 0.04, 11: 0.04, 12: 0.03, 13: 0.03, 14: 0.03, 
              15: 0.02, 16: 0.02, 17: 0.02, 18: 0.01}
